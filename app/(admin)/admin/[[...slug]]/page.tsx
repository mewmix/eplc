              ...
              fields: [
                {
                  ...
                  name: 'id',
                  widget: 'string',
                  hint: "Unique ID (e.g., 'apple-fuji'). Avoid changing.",
                },
                {
                  label: 'Display Name',
                  name: 'displayName',
                  widget: 'string',
                  hint: "Full name in catalog (e.g., Apple 'Fuji' 10/15 gal)",
                },
                {
                  label: 'Common Name',
                  name: 'commonName',
                ...
                },
                {
                  ...
                  name: 'containerSize',
                  widget: 'string',
                  hint: 'e.g., 5 gallon, 10/15 gallon',
                },
                {
                  label: 'Base Price ($)',
                  name: 'basePrice',
                  ...
                  min: 0,
                  step: 0.01,
                  hint: 'Wholesale/cost. Retail is auto-calculated.',
                },
                {
                ...
                },
                {
                  ...
                  hint: "Upload an image or enter a URL/path.",
                },
              ],
            },
          ],
